...
class TableLocationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tables = [
            ...
            ['table_number' => 4, 'location_description' => 'Közép terasz - 2 személyes', 'status' => 'available', 'active' => true],
            ['table_number' => 5, 'location_description' => 'Közép terasz - 6 személyes', 'status' => 'available', 'active' => true],
            ['table_number' => 6, 'location_description' => 'Jobb sarkok - ablak mellett', 'status' => 'available', 'active' => true],
            ['table_number' => 7, 'location_description' => 'Jobb sarkok - szarkány kép alatt', 'status' => 'available', 'active' => true],
            ['table_number' => 8, 'location_description' => 'Bal oldal - mosdó mellett', 'status' => 'available', 'active' => true],
            ...
            // Terasz asztalok
            ['table_number' => 11, 'location_description' => 'Terasz - bal sarkok', 'status' => 'available', 'active' => true],
            ['table_number' => 12, 'location_description' => 'Terasz - közép', 'status' => 'available', 'active' => true],
            ['table_number' => 13, 'location_description' => 'Terasz - jobb sarkok', 'status' => 'available', 'active' => true],
            ...
            ['table_number' => 20, 'location_description' => 'Sarokülés - bejárat mellett', 'status' => 'reserved', 'active' => true],
        ];
